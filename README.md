...
- Cinematic Custom Scrollbar: 투박한 시스템 기본 스크롤바 대신, 다크 테마와 브랜드 시그니처 컬러에 맞춘 커스텀 스크롤바를 전역 적용하여 시각적 일체감을 극대화했습니다.
- System Live Indicator: 푸터 영역에 실시간으로 깜빡이는 'System Online' 펄스 뱃지를 배치하여 관제 센터(SOC) 특유의 긴장감과 신뢰도를 부여했습니다.
